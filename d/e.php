...
<body>
    <div class="container my-5">
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form method="post" action="f.php" class="row g-3">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    if (isset($_POST['Submit'])) {
                        ...
                        echo "<div class='row'>";
                        echo "<div class='col-md-12'><p><strong>ตำแหน่งที่สมัคร:</strong> {$position}</p></div>";
                        
                        echo "<div class='col-md-6'><p><strong>ชื่อ-สกุล:</strong> {$prefix} {$fullname}</p></div>";
                        echo "<div class='col-md-6'><p><strong>เบอร์โทร:</strong> {$phone}</p></div>";
                        
                        echo "<div class='col-md-6'><p><strong>วันเดือนปีเกิด:</strong> {$birthday}</p></div>";
                        echo "<div class='col-md-6'><p><strong>ส่วนสูง:</strong> {$height} ซม.</p></div>";
                        
                        echo "<div class='col-md-12'><p><strong>ที่อยู่:</strong> <br>{$address}</p></div>";

                        echo "<div class='col-md-6'><p><strong>ระดับการศึกษา:</strong> {$education}</p></div>";
                        echo "<div class='col-md-6'><p><strong>สาขาวิชา:</strong> {$major}</p></div>";
                        
                        echo "<div class='col-md-12'><p><strong>ความสามารถพิเศษ/ทักษะ:</strong> <br>{$skills}</p></div>";
                        echo "<div class='col-md-12'><p><strong>ประสบการณ์ทำงาน:</strong> <br>{$experience}</p></div>";

                        echo "<div class='col-md-12'><p class='d-flex align-items-center'><strong>สีที่ชอบ:</strong> <span class='color-box ms-2' style='background-color:{$color};' title='{$color}'></span> <code>{$color}</code></p></div>";

                        echo "</div>"; // end row
                    } else {
                        echo "<p class='text-muted'>**กรุณากรอกข้อมูลในฟอร์มด้านบนแล้วกด 'สมัครสมาชิก' เพื่อดูผลลัพธ์**</p>";
                    }
                    ?>
                </div>
            </div>
