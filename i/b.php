...
if(isset($_POST['Submit'])){
    ...
    //copy($_FILES['pimage']['tmp_name'],"imag/".$pid.".".$ext);
...
?>
    <tr>
        ...
        <td width="80" align="center"><a href="delete_province.php?id=<?php echo $data['p_id']; ?>$ext=<?php echo $data['p_ext'];?>"onClick="return confirm('ยืนยันการลบ?');"><img src="images/tung.jpg" width="80"></a></td>
    </tr>
<?php } ?>
</table>
</body>
